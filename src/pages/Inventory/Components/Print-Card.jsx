  ...
  return (
    <div className="sched-modal-overlay" onClick={onClose}>
      ...
      >
        ...
        <p className="print-instructions">Select the schedules you want to include in the PDF, then click "Generate PDF".</p>
            ...
            <>
              ...
              <div className="print-checkbox-container">
                {meetings.map((meeting) => {
                  ...
                  return (
                    <div key={meeting.id} className="schedule-card-row print-checkbox-item">
                      <div className="schedule-card-cell print-checkbox-cell" onClick={() => handleSelectMeeting(meeting.id, !isSelected)}>
                        <input
                          type="checkbox"
                      ...
                      <div className="schedule-card-cell">{school?.Name || "Loading..."}</div>
                      <div className="schedule-card-cell">{school?.Address || "N/A"}</div>
        ...
        <button className="sched-submit" onClick={generatePDF} disabled={isGenerating}>
